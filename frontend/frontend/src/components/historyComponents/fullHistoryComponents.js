...
export default function FullHistoryComponents({username, measureGetter, pastDates})
{
    return (
        <div style={{ display: "flex", flexDirection: "column", justifyContent: 'space-between', }}>
            ...
            <div style={{padding:10, boxShadow: "7px 7px #8daee0", background: "linear-gradient(110deg, #f0f6ff, #e8f2ff"}}> 
                ...
                <PastWorkouts getStats={measureGetter} username={username} pastDates={pastDates} style={{ width: '125%', height: '125%' }} />
            </div>
